...
def get_course_number(record, delimiter=','):
    ...
    Returns:
        str: course number
    """
    return record.split(delimiter)[0] # chained index operator

    # person = record.split(delimiter) # creates list
    # return person[0] # course number
...
def get_person_name(record, delimiter=','):
    ...
    Returns:
        str: person name
    """
    return record.split(delimiter)[1] # chained index operator
...
def get_person_role(record, delimiter=','):
    ...
    Returns:
        str: role
    """
    return record.split(delimiter)[3] # chained index operator

    # person = record.split(delimiter) # creates list
    # return person[3] # role
...
def get_person_uniqname(record, delimiter=','):
    ...
    Returns:
        str: uniqname
    """
    return record.split(delimiter)[2] # chained index operator

    # person = record.split(delimiter) # creates list
    # return person[2] # uniqname
...
def calculate_percent(numerator, denominator):
    ...
    return round(percent, 2) # built-in function
