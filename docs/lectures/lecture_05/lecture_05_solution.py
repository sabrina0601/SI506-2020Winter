...
words = menu.replace(',', '').split() # method chaining
print("words = {}\n".format(words))
...
tofu_spam_menu = ' + Spam\n'.join(tofu_menu.splitlines()) # str.join()
...
# Append element to list (in-place)
lines.append('Red beans and rice + Spam') # modify in-place before variable reassignment
...
# Return element removed ("popped") from list by index position
