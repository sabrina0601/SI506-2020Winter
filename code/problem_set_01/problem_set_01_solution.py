...
# Note the below use of the f-string to incorporate a variable into the print
# statement.
...
# in the Zen of Python using the readlines() method. Return an integer rather than a
